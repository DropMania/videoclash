...
<p>
    The videoclash website located at https://www.videoclash.app/ is a
    copyrighted work belonging to videoclash. Certain features of the Site may
...
<p>
    ...
    the event of a dispute. These Terms of Use were created with the help of the <a
        href="https://www.termsofusegenerator.net">Terms Of Use Generator</a
    >.
</p>
...
<p>
    <strong>Certain Restrictions.</strong> The rights approved to you in these Terms
    ...
    or reverse engineer any part of the Site; (c) you shall not access the Site in
    ...
    downloaded, displayed, posted or transmitted in any form or by any means unless
    otherwise indicated, any future release, update, or other addition to functionality
    of the Site shall be subject to these Terms.  All copyright and other proprietary
...
<p>
    ...
    not responsible for any Third-Party Links & Ads.  Company provides access to
    these Third-Party Links & Ads only as a convenience to you, and does not review,
    approve, monitor, endorse, warrant, or make any representations with respect
    to Third-Party Links & Ads.  You use all Third-Party Links & Ads at your own
...
<p>
    <strong>Other Users.</strong> Each Site user is solely responsible for any and
    all of its own User Content.  Because we do not control User Content, you acknowledge
    and agree that we are not responsible for any User Content, whether provided
    by you or by others.  You agree that Company will not be responsible for any
    loss or damage incurred as the result of any such interactions.  If there is
    a dispute between you and any Site user, we are under no obligation to become
    involved.
</p>
...
<p>
    <strong>Cookies and Web Beacons.</strong> Like any other website, videoclash
...
<p>
    ...
    or safe.  If applicable law requires any warranties with respect to the
    site, all such warranties are limited in duration to ninety (90) days from
...
<p>
    ...
    this Arbitration Agreement.  Unless otherwise agreed to, all arbitration proceedings
...
<p>
    ...
    Notice of Dispute describing the nature and basis of the claim or dispute, and
    the requested relief.  A Notice to the Company should be sent to: n/a. After
    the Notice is received, you and the Company may attempt to resolve the claim
...
<p>
    ...
    by calling the AAA at 1-800-778-7879.  The arbitration shall be conducted by
    a single, neutral arbitrator.  Any claims or disputes where the total amount
    of the award sought is less than Ten Thousand U.S. Dollars (US $10,000.00) may
    be resolved through binding non-appearance-based arbitration, at the option of
    the party seeking relief.  For claims or disputes where the total amount of the
    award sought is Ten Thousand U.S. Dollars (US $10,000.00) or more, the right
    to a hearing will be determined by the Arbitration Rules.  Any hearing will be
    held in a location within 100 miles of your residence, unless you reside outside
    of the United States, and unless the parties agree otherwise.  If you reside
    ...
    by the arbitrator may be entered in any court of competent jurisdiction.  If
    the arbitrator grants you an award that is greater than the last settlement offer
    ...
    own costs and disbursements arising out of the arbitration and shall pay an equal
...
<p>
    ...
    an individual under applicable law, the AAA Rules, and the Terms.  The arbitrator
    ...
    same authority to award relief on an individual basis that a judge in a court
...
<p>
    ...
    JURY, instead electing that all claims and disputes shall be resolved by arbitration
    ...
    are subject to very limited review by a court.  In the event any litigation should
    ...
    ALL RIGHTS TO A JURY TRIAL, instead electing that the dispute be resolved by
    a judge.
</p>
...
<p>
    <strong>Confidentiality.</strong> All aspects of the arbitration proceeding shall
    be strictly confidential.  The parties agree to maintain confidentiality unless
...
<p>
    <strong>Right to Waive.</strong> Any or all of the rights and limitations set
...
<p>
    <strong>Small Claims Court.</strong> Nonetheless the foregoing, either you or
    the Company may bring an individual action in small claims court.
</p>

<p>
    <strong>Emergency Equitable Relief.</strong> Anyhow the foregoing, either party
...
<p>
    <strong>Electronic Communications.</strong> The communications between you and
    ...
    For contractual purposes, you (a) consent to receive communications from Company
    ...
    satisfy any legal obligation that such communications would satisfy if it were
    be in a hard copy writing.
</p>

<p>
    <strong>Entire Terms.</strong> These Terms constitute the entire agreement between
    you and us regarding the use of the Site. Our failure to exercise or enforce
    any right or provision of these Terms shall not operate as a waiver of such right
    or provision. The section titles in these Terms are for convenience only and
    ...
    the other provisions of these Terms will be unimpaired and the invalid or unenforceable
...
<p>Address: n/a</p>
<p>Email: robinhallerbach13@googlemail.com</p>
